  ...
  text: {
    ...
    subFeatures: {
      ...
      content: {
        ...
        fr: "Notre version coach pro est livrée avec un certain nombre de fonctionnalités : le <br><ul><li>coaching vocal pour tous les héros que Dota2 a à offrir. </li><li>Timers Ultimate ajustables pour l'ennemi et votre équipe. </li><li>Ajoutez une expérience gratuite de Dota Coach. </li><li>Rôle Supporter Discord. </li></ul>", // #toBeUpdated
        ru: "Наша версия для профессиональных тренеров имеет ряд функций: <br><ul><li>голосовой коучинг для всех героев, которые может предложить Dota2. </li><li>Регулируемые таймеры Ultimate для противника и вашей команды. </li><li>Добавьте бесплатный опыт Dota Coach. </li><li>Роль сторонника Discord. </li></ul>", // #toBeUpdated
        id: "Versi pelatih pro kami hadir lama dengan sejumlah fitur:<br><ul><li>Pelatihan suara untuk semua pahlawan yang ditawarkan Dota2. </li><li>Timer Ultimate yang dapat disesuaikan untuk musuh dan tim Anda. </li><li>Tambahkan pengalaman Dota Coach gratis. </li><li>Peran pendukung Discord. </li></ul>", // #toBeUpdated
        fil: "Ang aming pro coach version ay may mahabang bilang ng mga tampok:<br><ul><li>Voice coaching para sa lahat ng mga bayani Dota2 ay dapat mag-alok. </li><li>Adjustable Ultimate timers para sa kaaway at ang iyong koponan. </li><li>Magdagdag ng libreng Dota Coach karanasan. </li><li>Tungkulin ng Tagasuporta ng Discord. </li></ul>", // #toBeUpdated
    ...
    subPayment: {
      question: {
        ...
        br: "Quais opções de pagamento eu tenho?", // #toBeUpdated
    ...
    subCancel: {
      question: {
        ...
        br: "Como posso cancelar minha assinatura?", // #toBeUpdated
      ...
      de: "Alle Abonnements werden von Overwolf bearbeitet. </a><br>Wenn Sie Ihr Abonnement kündigen, eine Rückerstattung tätigen oder vergessen haben möchten, folgen Sie bitte den OfficaLoverwolf <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> FAQ.", // #toBeUpdated
      fr: "Tous les abonnements sont gérés par Overwolf. </a><br>Si vous souhaitez annuler votre abonnement, rembourser ou oublier d'annuler, veuillez suivre la <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> FAQ OfficalOverwolf.", // #toBeUpdated
      ru: "Все подписки обрабатываются Overwolf. </a><br>Если вы хотите отменить подписку, вернуть деньги или забыли ее отменить, пожалуйста, следуйте инструкциям на <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> странице часто задаваемых вопросов OfficalOverwolf.", // #toBeUpdated
      id: "Semua langganan ditangani oleh Overwolf. </a><br>Jika Anda ingin membatalkan langganan, pengembalian dana atau lupa membatalkan, silakan ikuti <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> FAQ OfficalOverWolf.", // #toBeUpdated
      ...
      zh: "所有订阅均由 Overwolf 处理。</a><br>如果你想取消订阅、退款或忘记取消，请遵循 OfficaLoverWolf <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> 常见问题解答。", // #toBeUpdated
      br: "Todas as assinaturas são gerenciadas pela Overwolf. </a><br>Se você deseja cancelar sua assinatura, reembolsar ou esquecer de cancelar, siga as <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> perguntas frequentes do OfficialOverwolf.", // #toBeUpdated
      es: "Overwolf gestiona todas las suscripciones. </a><br>Si desea cancelar su suscripción, reembolsar u olvidó cancelar, siga las <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/'> preguntas frecuentes de OfficalOverWolf.", // #toBeUpdated
    },
    ...
    accCreate: {
      ...
      de: "<a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000176960-how-to-create-an-overwolf-account-'>Folgen Sie dem Overwolf Schritt für Schritt Tutorial, um zu erfahren, wie Sie ein Konto erstellen.</a> <br>", // #toBeUpdated
      fr: "<a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000176960-how-to-create-an-overwolf-account-'>Suivez le tutoriel étape par étape Overwolf pour savoir comment créer un compte.</a> <br>", // #toBeUpdated
      ru: "Следуйте пошаговому руководству overwolf <a class='link-danger' href =' https://support.overwolf.com/en/support/solutions/articles/9000176960-how-to-create-an-overwolf-account-'> о</a> том, как создать учетную запись. <br>", // #toBeUpdated
    ...
    appBanned: {
      ...
      de: "Mit <p><b>der Dota Coach-App werden Sie NICHT gebannt. </b><br>Die Dota Coach-App basiert auf der Overwolf-Plattform. <br>Die Overwolf-Plattform wurde in Zusammenarbeit mit Valve und dem Dota2-Team entwickelt. <br>Valve hat seit seinen Anfängen die Bemühungen von Anwendungen von Drittanbietern unterstützt, Inhalte und Systeme zu erstellen, die das Spielerlebnis verbessern. </p><br>Sie können hier mehr lesen: <a class='link-danger' href='https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned'>Overwolf wird dich nicht gebannt</a> <br>", // #toBeUpdated
      fr: "<p><b>L'application Dota Coach ne vous fera PAS bannir. </b><br>L'application Dota Coach est construite sur la plateforme Overwolf. <br>La plateforme Overwolf est construite en collaboration avec Valve et l'équipe Dota2. <br>Depuis ses débuts, Valve soutient les efforts d'applications tierces pour créer du contenu et des systèmes qui améliorent l'expérience du joueur. </p><br>Vous pouvez en savoir plus ici : <a class='link-danger' href='https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned'>Overwolf ne vous fera pas bannir</a> <br>", // #toBeUpdated
      ru: "<p><b>Приложение Dota Coach НЕ заблокирует вас. </b><br>Приложение Dota Coach построено на платформе Overwolf. <br>Платформа Overwolf построена в сотрудничестве с Valve и командой Dota2. <br>Valve с самого начала поддерживала усилия сторонних приложений по созданию контента и систем, улучшающих впечатления игроков. </p><br>Вы можете прочитать больше здесь: <a class='link-danger' href='https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned'>Overwolf не забанит вас</a> <br>", // #toBeUpdated
    ...
    appVideo: {
      ...
      de: "Unsere dreiminütige Videoanleitung findest du hier <a class='link-danger' href =' https://dota-coach.com/video/DotaCoachTutorial.mp4'>.</a>", // #toBeUpdated
      fr: "Vous trouverez notre guide vidéo de 3 minutes ici <a class='link-danger' href =' https://dota-coach.com/video/DotaCoachTutorial.mp4'>.</a>", // #toBeUpdated
      ru: "Наш 3-минутный видеогид вы можете найти здесь <a class='link-danger' href =' https://dota-coach.com/video/DotaCoachTutorial.mp4'>.</a>", // #toBeUpdated
    ...
    appGamestate: {
      ...
      content: {
        ...
        de: "Die Gamestate-Integration ist ein integraler Bestandteil von Dota Coach. Es wird von Valve bereitgestellt, um auf alle Ereignisse in einem Dota2-Spiel zuzugreifen. <br>Sie müssen '-gamestateintegration' als Dota2-Startparameter hinzufügen. <br>Ohne sie wird Dota Coach nicht funktionieren! <br>Weitere Informationen zur Aktivierung <a class='link-danger' href='https://support.overwolf.com/en/support/solutions/articles/9000212745-how-to-enable-game-state-integration-for-dota-2'>finden Sie hier</a>.", // #toBeUpdated
        fr: "L'intégration de l'état de jeu fait partie intégrante de Dota Coach. Il est fourni par Valve pour accéder à tous les événements d'un jeu Dota2. <br>Vous devez ajouter « -gamestateintegration » en tant que paramètre de lancement Dota2. <br>Sans cela, Dota Coach ne fonctionnera pas ! <br>Pour plus d'informations sur la façon de l'activer, cliquez <a class='link-danger' href='https://support.overwolf.com/en/support/solutions/articles/9000212745-how-to-enable-game-state-integration-for-dota-2'>ici</a>.", // #toBeUpdated
        ru: "Интеграция с игровым состоянием является неотъемлемой частью Dota Coach. Он предоставляется Valve для доступа ко всем событиям в игре Dota2. <br>Вы должны добавить «-gamestateintegration» в качестве параметра запуска Dota2. <br>Без него Dota Coach не будет работать! <br>Для получения дополнительной информации о том, как включить его, нажмите <a class='link-danger' href='https://support.overwolf.com/en/support/solutions/articles/9000212745-how-to-enable-game-state-integration-for-dota-2'>здесь</a>.", // #toBeUpdated
    ...
    appTranslation: {
      ...
      content: {
        ...
        de: "Ja natürlich! Kontaktiere uns hier: <br><ul><li><a class='link-danger' href='https://discord.gg/uabGsGazRe'>Discord</a></li> <li><a class='link-danger' href='https://github.com/roserens/dotaCoach-i18n'>Github</a></li> <li>info (at) dota-coach.com</li>", // #toBeUpdated
        fr: "Oui, bien sûr ! Contactez-nous ici : <br><ul><li><a class='link-danger' href='https://discord.gg/uabGsGazRe'>Discord</a></li> <li><a class='link-danger' href='https://github.com/roserens/dotaCoach-i18n'>Github</a></li> <li>info (at) dota-coach.com</li>", // #toBeUpdated
        ru: "Да, конечно! Свяжитесь с нами здесь: <br><ul><li><a class='link-danger' href='https://discord.gg/uabGsGazRe'>Discord</a></li> <li>информация <li><a class='link-danger' href='https://github.com/roserens/dotaCoach-i18n'>Github</a></li> (at) dota-coach.com</li>", // #toBeUpdated
    ...
    issueBug: {
      ...
      content: {
        ...
        de: "Sie finden die Schaltfläche „Problem melden“ im oberen Menü des Desktop-Anwendungsfensters. <br>Wenn du weitere Hilfe benötigst, trete bitte unserem <a class='link-danger' href='https://discord.gg/uabGsGazRe'>Discord</a> Server bei! <br><div class='mt-2'></div><img src='images/faqs/bugreport.png' class='img-fluid rounded shadow'>", // #toBeUpdated
        fr: "Vous trouverez le bouton « Signaler un problème » dans le menu supérieur de la fenêtre de l'application de bureau. <br>Si vous avez besoin d'aide supplémentaire, rejoignez notre serveur <a class='link-danger' href='https://discord.gg/uabGsGazRe'>Discord</a> ! <br><div class='mt-2'></div><img src='images/faqs/bugreport.png' class='img-fluid rounded shadow'>", // #toBeUpdated
        ru: "Кнопка «сообщить о проблеме» находится в верхнем меню окна настольного приложения. <br>Если вам нужна дополнительная помощь, присоединяйтесь к нашему серверу <a class='link-danger' href='https://discord.gg/uabGsGazRe'>Discord</a>! <br><div class='mt-2'></div><img src='images/faqs/bugreport.png' class='img-fluid rounded shadow'>", // #toBeUpdated
    ...
    timerStart: {
      ...
      content: {
        ...
        br: "<p>Clique com o botão esquerdo nos temporizadores para ativá-los. Isso funciona para Roshan, Glifo da Fortificação, Recompras e Ultimates. <br><div style='display:flex'><div style='width: 40%'>Temporizador Roshan antes da ativação:</div> <br><img class='img-fluid rounded shadow' src='./images/faqs/roshan_timer_inactive.png' style='width:80%'><div style='width: 40%'>temporizador<div class='mt-2'></div> Roshan após a ativação: <br><div class='mt-2'></div> </div></div><img class='img-fluid rounded shadow' src='./images/faqs/roshan_timer_active.png' style='width:80%'>", // #toBeUpdated
    ...
    timerStop: {
      question: {
        ...
        br: "Como faço para parar um cronômetro?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Clique na cruz vermelha para parar o cronômetro. <br>", // #toBeUpdated
    ...
    timerAnnounce: {
      question: {
        ...
        br: "Como anuncio um cronômetro?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Você pode compartilhar temporizadores ativos clicando com o botão esquerdo neles. <br>Em seguida, o aplicativo publica automaticamente o status do cronômetro no bate-papo da equipe. <br><br>Exemplo de temporizadores de recompra durante uma partida: <br><img class='img-fluid rounded shadow' src='./images/faqs/buyback_timers.png' style='width: 38%'><br><br>Postagem<div class='mt-2'></div> resultante no bate-papo da equipe: <br><div class='mt-2'></div> <img class='img-fluid rounded shadow' src='./images/faqs/buyback_timers_chat.png' style='width: 57%'><br><br>Isso funciona para Roshan, Aegis, Glifo da Fortificação, Recompras e Ultimates.", // #toBeUpdated
    ...
    timerDisable: {
      question: {
        ...
        br: "Como desativo um temporizador?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Abra a janela de configurações. <br>Você pode encontrá-lo no canto superior direito em “alterar configurações”. <br>Você pode ver os componentes dos temporizadores que você não deseja ver. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/timers.png'>", // #toBeUpdated
    ...
    timerMissing: {
      question: {
        ...
        br: "Por que não vejo temporizadores?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Existem vários motivos pelos quais seus cronômetros não são exibidos. <br>Se o coordenador de jogo do Dota 2 não for encontrado, o Dota Coach não obterá nenhum dado sobre a partida, o que resultará em nenhum cronômetro. <br>Outro motivo é o parâmetro de lançamento ausente 'gamestateintegration'. Certifique-se de que ele seja adicionado. Consulte nossas perguntas frequentes sobre como adicioná-lo. <br>Às vezes, os temporizadores podem desaparecer durante o reposicionamento. <br>Basta clicar no botão 'redefinir' na janela de configurações. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/reset_position.png'>", // #toBeUpdated
    ...
    gamemodeSupport: {
      question: {
        ...
        br: "Quais modos de jogo você suporta?", // #toBeUpdated
      ...
      content: {
        ...
        br: "O Dota Coach funciona em todos os modos de jogo. <br>Mas esteja ciente de que alguns temporizadores e horários podem não estar totalmente operacionais em partidas Turbo. O <br>Ability Draft também não é totalmente suportado. <br>", // #toBeUpdated
    ...
    gamemodeSpectate: {
      question: {
        ...
        br: "Posso assistir a jogos?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Sim, você pode! O Dota Coach funciona no modo espectador. <br>Isso melhorará sua experiência geral do espectador ao fornecer informações adicionais. <br>Experimente! <br>", // #toBeUpdated
    ...
    gamemodeTournament: {
      question: {
        ...
        br: "Posso usar o aplicativo em torneios oficiais/jogos com ingressos?", // #toBeUpdated
      ...
      content: {
        ...
        br: "A resposta curta é não. Os <br>jogos oficiais enviam os dados de integração do estado do jogo atrasados, o que resulta em temporizadores atrasados e funcionalidade ruim do aplicativo. <br>Você não pode usar o Dota Coach durante os jogos oficiais do torneio (jogos com ingressos). <br>", // #toBeUpdated
    ...
    heroguidesGet: {
      question: {
        ...
        br: "Como posso obter seus guias de heróis?", // #toBeUpdated
    ...
    heroguidesMissing: {
      question: {
        ...
        br: "Por que os Guias de Heróis não são mostrados?", // #toBeUpdated
      ...
      content: {
        ...
        de: "Wenn du unsere Heldenführer bereits abonniert hast und sie nicht im Spiel angezeigt werden, <br>starte Dota2 unbedingt neu! <br>Sie können einer „Demo Hero“ -Lobby beitreten und überprüfen, ob die Guides ordnungsgemäß geladen wurden. <br>Es ist wichtig, dass du sie im Spiel im Shop-Interface auswählst, nachdem du sie abonniert hast. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        fr: "Si vous êtes déjà abonné à nos guides de héros et qu'ils ne s'affichent pas dans le jeu, <br>assurez-vous de redémarrer Dota2 ! <br>Vous pouvez rejoindre un lobby « Demo Hero » et vérifier si les guides ont été correctement chargés. <br>Il est important que vous les sélectionniez en jeu dans l'interface de la boutique après vous y être abonné. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        ru: "Если вы уже подписались на наши руководства по героям, но они не отображаются в игре, <br>обязательно перезапустите Dota2! <br>Вы можете присоединиться к лобби «Demo Hero» и проверить, правильно ли загружены руководства. <br>Важно, чтобы вы выбрали их в игре в интерфейсе магазина после подписки на них. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        id: "Jika Anda sudah berlangganan Hero Guides kami dan mereka tidak menunjukkan dalam game,<br>pastikan untuk me-restart Dota2! <br>Anda dapat bergabung dengan lobi 'Demo Hero' dan memeriksa apakah panduan telah dimuat dengan benar. <br>Adalah penting bahwa Anda memilih mereka dalam game di antarmuka toko setelah Anda berlangganan mereka. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        fil: "Kung naka-subscribe ka na sa aming Mga Gabay sa Bayani at hindi sila nagpapakita ng in-game,<br>siguraduhing i-restart ang Dota2! <br>Maaari kang sumali sa lobby ng 'Demo Hero' at tingnan kung maayos ang mga gabay. <br>Mahalaga na piliin mo ang mga ito sa laro sa interface ng tindahan pagkatapos mong mag-subscribe sa kanila. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        zh: "如果你已经订阅了我们的英雄指南，但它们没有在游戏中显示，<br>请务必重启 Dota2！<br>你可以加入 “Demo Hero” 大厅，检查指南是否已正确加载。<br>订阅它们后，请务必在商店界面中在游戏中选择它们。<br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        br: "Se você já se inscreveu em nossos Guias de Heróis e eles não aparecem no jogo, <br>certifique-se de reiniciar o Dota2! <br>Você pode entrar em um lobby 'Demo Hero' e verificar se os guias foram carregados corretamente. <br>É importante que você os selecione no jogo na interface da loja depois de assiná-los. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
        es: "Si ya te has suscrito a nuestras Guías de héroes y no aparecen en el juego, ¡<br>asegúrate de reiniciar Dota2! <br>Puedes unirte a un lobby de «Demo Hero» y comprobar si las guías se han cargado correctamente. <br>Es importante que los selecciones en el juego en la interfaz de la tienda después de suscribirte a ellos. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>", // #toBeUpdated
      },
    },
    heroguidesGood: {
      question: {
        ...
        br: "Seus guias de heróis são bons?", // #toBeUpdated
      ...
      content: {
        ...
        de: "Alle Heldenführer, die wir zur Verfügung stellen, werden von professionellen Dota2-Trainern und -Spielern erstellt und gewartet. <br>Ihre Ränge im Spiel liegen zwischen Immortal Rang 1000 und Immortal Rang 100 (8000 - 10000 MMR). <br>Sie können ihre Ränge auf den offiziellen <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>Dota2-Bestenlisten nachschlagen</a>.", // #toBeUpdated
        fr: "Tous les guides des héros que nous fournissons sont créés et maintenus par des entraîneurs et des joueurs professionnels de Dota2. <br>Leurs rangs dans le jeu se situent entre le rang immortel 1000 et le rang immortel 100 (8000 - 10000 MMR). <br>Vous pouvez consulter leurs rangs dans les <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>classements</a> officiels de Dota2.", // #toBeUpdated
        ru: "Все предоставляемые нами руководства по героям созданы и поддерживаются профессиональными тренерами и игроками Dota2. <br>Их внутриигровые ранги находятся в диапазоне от 1000 до 100 ранга бессмертия (8000 - 10000 MMR). <br>Их рейтинги можно посмотреть в официальных <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>списках лидеров</a> Dota2.", // #toBeUpdated
        id: "Semua Panduan Pahlawan yang kami sediakan dibuat dan dikelola oleh pelatih dan pemain Dota2 profesional. <br>Peringkat dalam game mereka adalah bewteen Immortal Rank 1000 dan Immortal Rank 100 (8000 - 10000 MMR). <br>Anda dapat mencari peringkat mereka di resmi Dota2 <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>Leaderboards</a>.", // #toBeUpdated
        fil: "Ang lahat ng mga Gabay sa Hero na aming ibinibigay ay nilikha at pinananatili ng mga propesyonal na Dota2 coaches at mga manlalaro. Ang<br>kanilang mga in-game ranggo ay sa pagitan ng Immortal na Ranggo 1000 at Immortal na Ranggo 100 (8000 - 10000 MMR). <br>Maaari mong tingnan ang kanilang mga ranggo sa opisyal na Dota2 <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>Leaderboards</a>.", // #toBeUpdated
        zh: "我们提供的所有英雄指南都是由专业的Dota2教练和玩家创建和维护的。<br>他们在游戏中的排名介于不朽等级 1000 和不朽等级 100（8000-10000 MMR）之间。<br>你可以在官方的Dota2 <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>排行榜</a>上查看他们的排名。", // #toBeUpdated
        br: "Todos os Guias de Heróis que fornecemos são criados e mantidos por treinadores e jogadores profissionais do Dota2. <br>Suas classificações no jogo estão entre Immortal Rank 1000 e Immortal Rank 100 (8000 - 10000 MMR). <br>Você pode procurar suas classificações nas <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>tabelas de classificação</a> oficiais do Dota2.", // #toBeUpdated
        es: "Todas las Hero Guides que proporcionamos son creadas y mantenidas por entrenadores y jugadores profesionales de Dota2. <br>Sus rangos en el juego están entre el rango inmortal 1000 y el rango inmortal 100 (8000 - 10000 MMR). <br>Puedes buscar sus rangos en las <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>tablas de clasificación</a> oficiales de Dota2.", // #toBeUpdated
      },
    },
    // Windows
    windowMissing: {
    ...
    windowShowHide: {
      question: {
        ...
        br: "Como posso ocultar/mostrar janelas enquanto jogo?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Para ocultar/mostrar janelas do jogo durante o jogo, pressione a tecla de atalho atribuída. <br>A tecla de atalho padrão é 'CTRL + b'. <br>Se você quiser alterar a tecla de atalho, vá para as configurações do aplicativo overwolf. <br>Verifique nossas perguntas frequentes em “Teclas de atalho” se não tiver certeza de onde encontrá-las. <br>", // #toBeUpdated
    ...
    windowReposition: {
      question: {
        ...
        br: "Como posso reposicionar janelas?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Abra o menu de configurações no canto superior direito da janela da área de trabalho. <br>Ative o controle deslizante Reposicionar no canto inferior direito da janela de configurações. <br>Desative o controle deslizante Reposicionar quando terminar para proteger suas novas posições. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/reposition.png'>", // #toBeUpdated
    ...
    windowGreen: {
      question: {
        ...
        br: "Por que todas as janelas são verdes?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Suas janelas ficarão verdes se o controle deslizante de reposição no menu de configurações estiver definido como ativo. <br>Abra o menu de configurações no canto superior direito da janela da área de trabalho. <br>Desative o controle deslizante Reposicionar no canto inferior direito da janela de configurações. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/reposition.png'>", // #toBeUpdated
    ...
    windowPickBan: {
      question: {
        ...
        br: "Como posso ver sugestões de separação/banimento?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Depois de entrar em um jogo e o rascunho começar, um logotipo do Dota Coach aparecerá no canto superior esquerdo. <br>Clique nele para mostrar ou ocultar as informações do rascunho. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/buttondraft.png'>", // #toBeUpdated
    ...
    windowRole: {
      question: {
        ...
        br: "Como posso abrir a seleção de função?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Depois de entrar em um jogo, um logotipo do Dota Coach aparecerá acima do minimapa. <br>Clique nele para mostrar ou ocultar a seleção de função e as informações de rota. <br>", // #toBeUpdated
    ...
    windowDisable: {
      question: {
        ...
        br: "Como posso desativar as janelas que não gosto?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Abra as configurações no canto superior direito da janela da área de trabalho e selecione 'alterar configurações'. <br>Você pode desativar os seguintes componentes da janela: <ul><li>Infoboxes</li> <li>Todos os temporizadores individuais (equipe própria e inimiga)</li> <li>Contagens regressivas de runas</li><li>Rastreador de desempenho</li> <li>Janela de legenda</li></ul>", // #toBeUpdated
    ...
    windowSecond: {
      ...
      content: {
        ...
        br: "Abra as configurações no canto superior direito da janela da área de trabalho e selecione 'alterar configurações'. <br>Selecione seu segundo monitor ou principal para ativar a janela. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/secondscreen.png'>", // #toBeUpdated
    ...
    audioDisable: {
      question: {
        ...
        br: "Como desativo as mensagens de áudio?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Abra as configurações no canto superior direito da janela da área de trabalho e selecione 'alterar configurações'. <br>Você pode desativar os seguintes componentes de voz individualmente: <ul><li>Notificações</li> <li>Treinamento de voz próprio herói</li> <li>Treinamento de voz heróis inimigos</li></ul>", // #toBeUpdated
    ...
    audioVolume: {
      question: {
        ...
        br: "Como posso ajustar o volume do som?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Abra as configurações no canto superior direito da janela da área de trabalho e selecione 'alterar configurações'. <br>Você pode encontrar o controle de ajuste de volume no canto superior direito da janela de configurações. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/audio.png'>", // #toBeUpdated
    ...
    audioMissing: {
      question: {
        ...
        br: "O áudio não está sendo reproduzido, como posso ativá-lo?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Abra as configurações no canto superior direito da janela da área de trabalho e selecione 'alterar configurações'. <br>Você pode encontrar o controle de saída de som no canto superior direito da janela de configurações. <br>Certifique-se de selecionar o alto-falante adequado (saída de áudio) e se o volume não é zero por cento. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/audio.png'>", // #toBeUpdated
    ...
    hotkeyMissclick: {
      question: {
        ...
        br: "Como posso ativar a proteção contra cliques errados?", // #toBeUpdated
      ...
      content: {
        ...
        br: "Para evitar cliques errados nas janelas do jogo, você pode ativar um modificador de proteção contra cliques errados. <br>Isso tornará as janelas apenas interativas se o modificador for pressionado ao clicar com o mouse. <br>Nós suportamos 'alt', 'ctrl' e 'shift'. <br>Abra as configurações no canto superior direito da janela da área de trabalho e selecione 'alterar configurações'. <br>Você pode encontrar a tecla 'Modificador de clique do mouse' no canto superior direito da janela de configurações. <br>Observe que se você selecionar 'shift' ou 'ctrl' como modificador, anunciar temporizadores no chat não funcionará mais. <br><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/mouseclickmod.png'>", // #toBeUpdated
    ...
    hotkeyModifier: {
      question: {
        ...
        br: "O que é a chave modificadora?", // #toBeUpdated
      ...
      content: {
        ...
        br: "A tecla modificadora foi introduzida para evitar erros de cliques nos elementos da janela. <br>Se você tiver problemas com cliques errados nas janelas, certifique-se de habilitar a tecla modificadora.", // #toBeUpdated
    ...
    hotkeyChange: {
      question: {
        ...
        br: "Onde posso mudar as teclas de atalho? ", // #toBeUpdated
      ...
      content: {
        ...
        de: "Der App-Hotkey wird in den Einstellungen der Overwolf-Anwendung geändert. <br><ul><li>Klicke mit der rechten Maustaste auf das Overwolf-Symbol in deiner Taskleiste. </li><li>Wählen Sie die Einstellungen. </li><li>Wählen Sie in der oberen linken Ecke Overlay & Hotkeys aus. </li><li>Wähle Dota2 als Spiel aus. </li><li>Gehen Sie zum Dota Coach Section. </li><li>Ändern Sie die Hotkeys an Ihre Bedürfnisse. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        fr: "Le raccourci clavier de l'application est modifié dans les paramètres de l'application overwolf. <br><ul><li>Cliquez avec le bouton droit sur le symbole Overwolf dans votre barre des tâches. </li><li>Sélectionnez les paramètres. </li><li>Sélectionnez Superposition et raccourcis clavier dans le coin supérieur gauche. </li><li>Sélectionnez Dota2 comme jeu. </li><li>Accédez à la section des entraîneurs Dota. </li><li>Modifiez les touches de raccourci selon vos besoins. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        ru: "Горячие клавиши приложения изменены в настройках приложения overwolf. <br><ul><li>Щелкните правой кнопкой мыши символ overwolf на панели задач. </li><li>Выберите настройки. </li><li>Выберите Overlay & Hotkeys в левом верхнем углу. </li><li>Выберите Dota2 в качестве игры. </li><li>Зайдите в раздел тренера по Dota. </li><li>Измените горячие клавиши в соответствии с вашими потребностями. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        id: "Hotkey aplikasi diubah dalam pengaturan aplikasi overwolf. <br><ul><li>Klik kanan simbol overwolf di taskbar Anda. </li><li>Pilih pengaturan. </li><li>Pilih Overlay & Hotkeys di pojok kiri atas. </li><li>Pilih Dota2 sebagai permainan. </li><li>Pergi ke Bagian Pelatih Dota. </li><li>Ubah hotkeys sesuai kebutuhan Anda. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        fil: "Ang hotkey ng app ay binago sa mga setting ng overwolf application. <br><ul><li>I-right-click ang simbolo ng overwolf sa iyong taskbar. </li><li>Piliin ang mga setting. </li><li>Piliin ang Overlay & Hotkeys sa kaliwang sulok sa itaas. </li><li>Piliin ang Dota2 bilang laro. </li><li>Pumunta sa Seksyon ng Dota Coach. </li><li>Baguhin ang mga hotkey sa iyong mga pangangailangan. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        zh: "在overwolf应用程序设置中更改了应用程序热键。<br><ul><li>右键单击任务栏中的 overwolf 符号。</li><li>选择设置。</li><li>选择左上角的叠加和热键。</li><li>选择 Dota2 作为游戏。</li><li>前往 Dota 教练专区。</li><li>根据需要更改热键。</li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        br: "A tecla de atalho do aplicativo é alterada nas configurações do aplicativo overwolf. <br><ul><li>Clique com o botão direito do mouse no símbolo do overwolf na barra de tarefas. </li><li>Selecione as configurações. </li><li>Selecione Sobreposição e teclas de atalho no canto superior esquerdo. </li><li>Selecione Dota2 como jogo. </li><li>Vá para a seção de treinadores do Dota. </li><li>Mude as teclas de atalho para suas necessidades. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
        es: "Las teclas de acceso rápido de la aplicación se cambian en la configuración de la aplicación overwolf. <br><ul><li>Haz clic con el botón derecho en el símbolo del lobo en la barra de tareas. </li><li>Selecciona los ajustes. </li><li>Selecciona Superposición y teclas de acceso rápido en la esquina superior izquierda. </li><li>Selecciona Dota2 como juego. </li><li>Ve a la sección Dota Coach. </li><li>Cambia las teclas de acceso rápido según tus necesidades. </li></ul><div class='mt-2'></div><img class='img-fluid rounded shadow' src='./images/faqs/overwolfhotkeys.png'>", // #toBeUpdated
      },
    },
  },
};
