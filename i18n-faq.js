  ...
  text: {
    ...
    subFeatures: {
      ...
      content: {
        ...
        br: `Nossa versão pro coach vem com vários recursos: <br><ul><li>Coaching de voz para todos os heróis que Dota 2 tem a oferecer. </li><li>Temporizadores Ultimate ajustáveis para o inimigo e sua equipe. </li><li>Adicione uma experiência gratuita do Dota Coach. </li><li>Papel do Supporter Discord. </li></ul>`, // #toBeUpdated
    ...
    appGetStarted: {
      ...
      content: {
        en: `<p>
						...
						A guide on how to add Dota 2 launch parameters can be found <a class="link-danger" href="https://support.overwolf.com/en/support/solutions/articles/9000212745-how-to-enable-game-state-integration-for-dota-2">here</a>.
    ...
    heroguidesMissing: {
      ...
      content: {
        ...
        br: `Se você já se inscreveu em nossos Guias de Heróis e eles não aparecem no jogo, <br>certifique-se de reiniciar o Dota 2! <br>Você pode entrar em um lobby 'Demo Hero' e verificar se os guias foram carregados corretamente. <br>É importante que você os selecione no jogo na interface da loja depois de assiná-los. <br><div class='mt-2'></div><img class='img-fluid rounded shadow w-50' src='./images/faqs/heroguides.png'>`, // #toBeUpdated
    ...
    heroguidesGood: {
      ...
      content: {
        en: `All Hero Guides that we provide are created and maintained by professional Dota 2 coaches and players.<br>
					...
					You can look up their ranks on the offical Dota 2 <a class="link-danger" href="https://www.dota2.com/leaderboards/#europe-0">Leaderboards</a>.`,
        ...
        id: `Semua Panduan Pahlawan yang kami sediakan dibuat dan dikelola oleh pelatih dan pemain Dota 2 profesional. <br>Peringkat dalam game mereka adalah bewteen Immortal Rank 1000 dan Immortal Rank 100 (8000 - 10000 MMR). <br>Anda dapat mencari peringkat mereka di resmi Dota 2 <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>Leaderboards</a>.`, // #toBeUpdated
        fil: `Ang lahat ng mga Gabay sa Hero na aming ibinibigay ay nilikha at pinananatili ng mga propesyonal na Dota 2 coaches at mga manlalaro. Ang<br>kanilang mga in-game ranggo ay sa pagitan ng Immortal na Ranggo 1000 at Immortal na Ranggo 100 (8000 - 10000 MMR). <br>Maaari mong tingnan ang kanilang mga ranggo sa opisyal na Dota 2 <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>Leaderboards</a>.`, // #toBeUpdated
        zh: `我们提供的所有英雄指南都是由专业的Dota 2教练和玩家创建和维护的。<br>他们在游戏中的排名介于不朽等级 1000 和不朽等级 100（8000-10000 MMR）之间。<br>你可以在官方的Dota 2 <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>排行榜</a>上查看他们的排名。`, // #toBeUpdated
        br: `Todos os Guias de Heróis que fornecemos são criados e mantidos por treinadores e jogadores profissionais do Dota 2. <br>Suas classificações no jogo estão entre Immortal Rank 1000 e Immortal Rank 100 (8000 - 10000 MMR). <br>Você pode procurar suas classificações nas <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>tabelas de classificação</a> oficiais do Dota 2.`, // #toBeUpdated
        es: `Todas las Hero Guides que proporcionamos son creadas y mantenidas por entrenadores y jugadores profesionales de Dota 2. <br>Sus rangos en el juego están entre el rango inmortal 1000 y el rango inmortal 100 (8000 - 10000 MMR). <br>Puedes buscar sus rangos en las <a class='link-danger' href='https://www.dota2.com/leaderboards/#europe-0'>tablas de clasificación</a> oficiales de Dota 2.`, // #toBeUpdated
      },
    },
    // Windows
    windowMissing: {
