...
const i18n = {
  ...
  text: {
    ...
    subGet: {
      ...
      content: {
        en: `After installing Dota Coach with the overwolf client, you can subscribe to our services.<br>
					...
					Also check out the <a class="link-danger" target="_blank" rel="noopener noreferrer" href="https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/">Overwolf FAQ</a>
        ...
        zh: `通过Overwolf安装DotaCoach客户端以后，即可订阅我们的服务。<br>
					...
					可以通过观看<a class="link-danger" target="_blank" rel="noopener noreferrer" href ="https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/">Overwolf FAQ</a>
					来学习如何订阅。<br>
					<div class="mt-2"></div>
					<img src="images/faqs/subscribesteps.png" class="img-fluid rounded shadow">`,
    ...
    subCancel: {
      ...
      content: {
        en: `All subscriptions are handled by Overwolf.<br>If you want to cancel your subscription, refund or forgot to cancel, please follow the offical <a class="link-danger" target="_blank" rel="noopener noreferrer" href ="https://support.overwolf.com/en/support/solutions/articles/9000178332-app-subscriptions-faq/">Overwolf FAQ</a>.`,
    ...
    accCreate: {
      ...
      content: {
        ...
        br: `Siga o tutorial passo a passo do overwolf <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://support.overwolf.com/en/support/solutions/articles/9000176960-how-to-create-an-overwolf-account-'> sobre</a> como criar uma conta. <br>`, // #toBeUpdated
    ...
    appGetStarted: {
      ...
      content: {
        en: `<p>
						...
						A guide on how to add Dota2 launch parameters can be found <a class="link-danger" target="_blank" rel="noopener noreferrer" href="https://support.overwolf.com/en/support/solutions/articles/9000212745-how-to-enable-game-state-integration-for-dota-2">here</a>.
    ...
    appHelp: {
      ...
      content: {
        en: `Join our Discord for live support <a class="link-danger" target="_blank" rel="noopener noreferrer" href ="https://discord.gg/uabGsGazRe">here</a>.`,
        de: `Treten Sie unserem Discord bei und erhalten Sie hier Live-Support <a class="link-danger" target="_blank" rel="noopener noreferrer" href =' https://discord.gg/uabGsGazRe'>.</a>`, // #toBeUpdated
        fr: `Rejoignez notre Discord pour une assistance en direct ici <a class="link-danger" target="_blank" rel="noopener noreferrer" href =' https://discord.gg/uabGsGazRe'>.</a>`, // #toBeUpdated
        ...
        br: `Junte-se ao nosso Discord para suporte ao vivo aqui <a class="link-danger" target="_blank" rel="noopener noreferrer" href =' https://discord.gg/uabGsGazRe'>.</a>`, // #toBeUpdated
        es: `Únete a nuestro Discord para recibir soporte en vivo aquí <a class="link-danger" target="_blank" rel="noopener noreferrer" href =' https://discord.gg/uabGsGazRe'>.</a>`, // #toBeUpdated
      },
    },
    appBanned: {
      question: {
      ...
      content: {
        en: `<p>
					...
					You can read more here: <a class="link-danger" target="_blank" rel="noopener noreferrer" href="https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned">Overwolf Won't Get You Banned</a><br>
					</p>`,
        ...
        fil: `<p><b>Ang Dota Coach app ay HINDI makakakuha ka ng pinagbawalan. </b><br>Ang Dota Coach app ay binuo sa ibabaw ng Overwolf platform. <br>Ang Overwolf platform ay binuo sa pakikipagtulungan sa Valve at sa koponan ng Dota2. Ang<br>balbula ay mula noong simula nito ay suportado ang mga pagsisikap ng mga application ng third party upang lumikha ng nilalaman at mga sistema na nagpapabuti sa karanasan ng manlalaro. </p><br>Maari kang magbasa nang higit pa rito: <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned'>Overwolf Won't Get You Banned</a><br>`, // #toBeUpdated
        zh: `<p><b>Dota Coach 应用程序不会让你被禁赛。</b><br>Dota Coach 应用程序建立在 Overwolf 平台之上。<br>Overwolf 平台是与 Valve 和 Dota2 团队合作构建的。<br>Valve自成立以来就一直支持第三方应用程序创建可增强玩家体验的内容和系统的努力。</p><br>你可以在这里阅读更多：<a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned'>Overwolf 不会让你被禁赛</a> <br>`, // #toBeUpdated
        br: `<p><b>O aplicativo Dota Coach NÃO fará com que você seja banido. </b><br>O aplicativo Dota Coach é construído sobre a plataforma Overwolf. <br>A plataforma Overwolf é construída em colaboração com a Valve e a equipe Dota2. <br>Desde o início, a Valve tem apoiado os esforços de aplicativos de terceiros para criar conteúdo e sistemas que aprimoram a experiência do jogador. </p><br>Você pode ler mais aqui: <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://support.overwolf.com/en/support/solutions/articles/9000182312-overwolf-won-t-get-you-banned'>Overwolf não fará com que você seja banido</a> <br>`, // #toBeUpdated
    ...
    appVideo: {
      ...
      content: {
        ...
        br: `Você pode encontrar nosso guia de vídeo de 3 minutos aqui <a class="link-danger" target="_blank" rel="noopener noreferrer" href =' https://dota-coach.com/video/DotaCoachTutorial.mp4'>.</a>`, // #toBeUpdated
    ...
    appTranslation: {
      ...
      content: {
        ...
        br: `Sim, claro! Entre em contato conosco aqui: <br><ul><li>Informações <li><a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://github.com/roserens/dotaCoach-i18n'>do Github</a></li> do <li><a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://discord.gg/uabGsGazRe'>Discord</a></li> (at) dota-coach.com</li>`, // #toBeUpdated
    ...
    issueApp: {
      ...
      content: {
        en: `<p>
						...
						Additional information how to add the launch parameter can be found <a class="link-danger" target="_blank" rel="noopener noreferrer" href="https://support.overwolf.com/en/support/solutions/articles/9000212745-how-to-enable-game-state-integration-for-dota-2">here</a>.
					</p>`,
    ...
    heroguidesGet: {
      ...
      content: {
        en: `We have created in-game guides for every hero in the game.<br>
					...
					Subscribe to the them <a class="link-danger" target="_blank" rel="noopener noreferrer" href="https://dota-coach.com/heropedia/">here</a>.<br>
    ...
    heroguidesGood: {
      ...
      content: {
        en: `All Hero Guides that we provide are created and maintained by professional Dota2 coaches and players.<br>
					...
					You can look up their ranks on the offical Dota2 <a class="link-danger" target="_blank" rel="noopener noreferrer" href="https://www.dota2.com/leaderboards/#europe-0">Leaderboards</a>.`,
        ...
        id: `Semua Panduan Pahlawan yang kami sediakan dibuat dan dikelola oleh pelatih dan pemain Dota2 profesional. <br>Peringkat dalam game mereka adalah bewteen Immortal Rank 1000 dan Immortal Rank 100 (8000 - 10000 MMR). <br>Anda dapat mencari peringkat mereka di resmi Dota2 <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://www.dota2.com/leaderboards/#europe-0'>Leaderboards</a>.`, // #toBeUpdated
        fil: `Ang lahat ng mga Gabay sa Hero na aming ibinibigay ay nilikha at pinananatili ng mga propesyonal na Dota2 coaches at mga manlalaro. Ang<br>kanilang mga in-game ranggo ay sa pagitan ng Immortal na Ranggo 1000 at Immortal na Ranggo 100 (8000 - 10000 MMR). <br>Maaari mong tingnan ang kanilang mga ranggo sa opisyal na Dota2 <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://www.dota2.com/leaderboards/#europe-0'>Leaderboards</a>.`, // #toBeUpdated
        zh: `我们提供的所有英雄指南都是由专业的Dota2教练和玩家创建和维护的。<br>他们在游戏中的排名介于不朽等级 1000 和不朽等级 100（8000-10000 MMR）之间。<br>你可以在官方的Dota2 <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://www.dota2.com/leaderboards/#europe-0'>排行榜</a>上查看他们的排名。`, // #toBeUpdated
        br: `Todos os Guias de Heróis que fornecemos são criados e mantidos por treinadores e jogadores profissionais do Dota2. <br>Suas classificações no jogo estão entre Immortal Rank 1000 e Immortal Rank 100 (8000 - 10000 MMR). <br>Você pode procurar suas classificações nas <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://www.dota2.com/leaderboards/#europe-0'>tabelas de classificação</a> oficiais do Dota2.`, // #toBeUpdated
        es: `Todas las Hero Guides que proporcionamos son creadas y mantenidas por entrenadores y jugadores profesionales de Dota2. <br>Sus rangos en el juego están entre el rango inmortal 1000 y el rango inmortal 100 (8000 - 10000 MMR). <br>Puedes buscar sus rangos en las <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://www.dota2.com/leaderboards/#europe-0'>tablas de clasificación</a> oficiales de Dota2.`, // #toBeUpdated
      },
    },
    // Windows
    windowMissing: {
