...
export const i18n = {
  ...
  text: {
    ...
    firstTimeUserNotification: {
      en: "Make sure to add '-gamestateintegration' to your Dota launch options (<span id='notificationlink'>Click here to show Guide</span>).<br><br>Costumize Dota Coach to your needs. Head to the settings menu in the top right corner!<br><hr>Interact with timers and infoboxes during the game to get the competetive edge:<br>- Press<b> LEFT-CLICK </b>to start Roshan-, Glpyh-, Buyback-, Ultimate-Timers.<br>- Press<b> the red X </b>to stop Roshan-, Glpyh-, Buyback-, Ultimate-Timers.<br>- Press<b> LEFT-CLICK </b>to open infoboxes at the top of the screen.<br><hr>You are now an important member of the Dota Coach community and we want to hear from you:<br>- Join our <span id='notificationlink'>Discord Server</span> to speak directly with our Pro-Coaches, find like-minded players and suggest Dota Coach changes!<br>- Join our <span id='notificationlink'>Subreddit</span> or follow Dota Coach on <span id='notificationlink'>social media</span> to get live updates on upcoming changes and improvements!<hr>Still got questions? No worries, we got you covered:<br>- <span id='notificationlink'>FAQ</span><br>- <span id='notificationlink'>Heropedia</span><hr>Do you want to unleash the full power of Dota Coach in 3 minutes? Watch the full guide video:<br><br><button id='notificationButton'>Guide Video</button><br>",
      de: "Füge '-gamestateintegration' zu deinen Dota-Startoptionen hinzu (<span id='notificationlink'>Klicke hier für weitere Informationen</span>). <br><br>Passe Dota Coach an deine Bedürfnisse an. Gehe dafür zum Einstellungsmenü in der oberen rechten Ecke!<br><hr>Interagiere während des Spiels mit Timern und Infoboxen, um dir einen Wettbewerbsvorteil zu verschaffen:<br>- Drücke <b>LINKSKLICK</b> um Roshan-, Glpyh-, Buyback- und Ultimate-Timer zu starten. <br>- Drücke <b>das rote X</b> um Roshan-, Glyph-, Buyback- und Ultimate-Timer zu stoppen.<br>- Drücke <b>Linksklick</b> um Infoboxen am oberen Bildschirmrand zu öffnen.<br><hr>Du bist jetzt ein wichtiges Mitglied der Dota Coach-Community und wir möchten von dir hören:<br>- Tritt unserem <span id='notificationlink'>Discord Server</span> bei um mit uns zu sprechen, gleichgesinnte Spieler zu finden und deine Ideen einzubringen!<br>- Tritt unserem <span id='notificationlink'>Subreddit</span> bei oder folge uns in den <span id='notificationlink'>sozialen Medien</span> um Live-Updates zu Verbesserungen zu erhalten! <hr>Hast du noch Fragen? Keine Sorge, wir haben alles für dich bereit:<br>- <span id='notificationlink'>FAQ</span><br>- <span id='notificationlink'>Heropedia</span><br><hr>Möchtest du die vollen Funktionalitäten von Dota Coach in 3 Minuten kennenlernen? Schaue unser Tutorialvideo an:<br><br><button id='notificationButton'>Video</button> <br>",
