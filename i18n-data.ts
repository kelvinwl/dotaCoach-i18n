...
export const i18n = {
  ...
  text: {
    ...
    GameStateIntegration: {
      ...
      fil: "Ang Dota Coach ay nangangailangan ng access sa Game State Integration API na ibinigay ng Dota 2. <br>Mangyaring siguraduhing idagdag ang '-gamestatereation' sa mga pagpipilian sa paglunsad ng Dota 2.",
    },
