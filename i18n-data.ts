...
export const i18n = {
  ...
  text: {
    ...
    firstTimeUserNotification: {
      ...
      de: "Achte darauf, '-gamestateintegration' zu deinen Dota-Startoptionen hinzuzufügen (<span id='notificationlink'>Klicke hier, um Guide anzuzeigen</span>). <br><br>Passen Sie Dota Coach an Ihre Bedürfnisse an. Gehe zum Einstellungsmenü in der oberen rechten Ecke! <br><hr>Interagiere während des Spiels mit Timern und Infoboxen, um dir einen Wettbewerbsvorteil zu verschaffen: <br><br>- Drücke die <b>LINKSKLICK</b>, um Roshan-, Glpyh-, Buyback- und Ultimate-Timer zu starten. <br>- Drücken Sie <b>das rote X</b>, um Roshan-, Glyph-, Buyback- und Ultimate-Timer zu stoppen. <br><br>- <b>Linksklick</b> drücken, um Infoboxen oben und auf der Minikarte zu öffnen. <br><hr>Du bist jetzt ein wichtiges Mitglied der Dota-Coach-Community <br>und wir möchten von dir hören: <br><br>- Tritt unserem <span id='notificationlink'>Discord Server</span> bei, um direkt mit unseren Pro-Coaches zu sprechen, <br>gleichgesinnte Spieler zu finden und Änderungen beim Dota Coach vorzuschlagen! <br><br>- Tritt unserem <span id='notificationlink'>Subreddit</span> bei oder folge Dota Coach in den <span id='notificationlink'>sozialen Medien</span><br>, um Live-Updates zu bevorstehenden Änderungen und Verbesserungen zu erhalten! <hr>Hast du noch Fragen? Keine Sorge, wir haben alles für Sie: <br><br>- <span id='notificationlink'>FAQ</span> <br><br>- <span id='notificationlink'>Heropedia</span> Sie <br><hr>möchten die volle Leistung von Dota Coach in 3 Minuten entfalten? <br>Sehen Sie sich das vollständige Video mit der <br><br><button id='notificationButton'>Anleitung an: Video</button> <br>",
