...
export const i18n = {
  ...
  text: {
    ...
    firstTimeUserNotification: {
      ...
      zh: "确保在你的 Dota 启动选项中添加 “-gamestateIntegration”（<span id='notificationlink'>点击此处查看指南</span>）。<br><br>根据您的需求打扮 Dota 教练。前往右上角的设置菜单！在@@ <br><hr>游戏过程中与计时器和信息框互动以获得竞争优势：<br><br>-按下<b>左键单击</b>以启动 Roshan-、Glyph-、Buyback-、Ultimate-Timers。<br>-按下<b>红色的 X</b> 可停止 Roshan-、Glyph-、Buyback-、Ultimate-Timers。<br><br>-按下<b>左键单击</b>以打开顶部和小地图上的信息框。<br><hr>您现在是Dota Coach社区的重要成员，<br>我们希望收到您的来信：<br><br>-加入我们的 <span id='notificationlink'>Discord服务器</span>直接与我们的专业教练交谈，<br>找到志同道合的玩家并建议Dota Coach的变化！<br><br>-加入我们的 <span id='notificationlink'>Subreddit</span> 或在<span id='notificationlink'>社交媒体</span>上关注Dota Coach<br>，以获取有关即将发生的更改和改进的实时更新！<hr>还有问题吗？不用担心，我们帮你解决了：<br><br>-<span id='notificationlink'>常见问题</span> <br><br>-<span id='notificationlink'>Heropedia</span> <br><hr>想在3分钟内释放Dota Coach的全部力量吗？<br>观看完整的指南视频：<br><br><button id='notificationButton'>指南视频</button> <br>",
      br: "Certifique-se de adicionar '-gamestateintegration' às suas opções de inicialização do Dota (<span id='notificationlink'>Clique aqui para mostrar o guia</span>). <br><br>Personalize o Dota Coach de acordo com suas necessidades. Vá para o menu de configurações no canto superior direito! <br><hr>Interaja com temporizadores e infoboxes durante o jogo para obter a vantagem competitiva: <br><br>- Pressione o <b>botão esquerdo</b> para iniciar Roshan-, Glifo-, Recompra-, Ultimate-Timers. <br>- Pressione <b>o X vermelho</b> para parar Roshan-, Glifo-, Recompra-, Temporizador-Ultimate. <br><br>- Pressione o <b>botão esquerdo</b> para abrir caixas de informações na parte superior e no minimapa. <br><hr>Agora você é um membro importante da comunidade Dota Coach <br>e queremos ouvir de você: <br><br>- Junte-se ao nosso <span id='notificationlink'>Discord Server</span> para falar diretamente com nossos Coaches Profissionais, <br>encontre jogadores com ideias semelhantes e sugira mudanças no Dota Coach <br><br>- Junte-se ao nosso <span id='notificationlink'>Subreddit</span> ou siga o Dota Coach nas <span id='notificationlink'>redes sociais</span> <br>para obter atualizações ao vivo sobre as próximas mudanças e melhorias! <hr>Ainda tem perguntas? Não se preocupe, nós ajudamos você: <br><br>- <span id='notificationlink'>FAQ</span> <br><br>- <span id='notificationlink'>Heropedia</span> <br><hr>Deseja liberar todo o poder do Dota Coach em 3 minutos? <br>Assista ao vídeo do guia completo: <br><br><button id='notificationButton'>Vídeo do guia</button> <br>",
